<div>
 <div class="bg-card border border-card-line rounded-xl shadow-2xs  mx-auto mt-5 mb-5  max-w-4xl">
  <!-- Sign In -->
  <div class="p-4 sm:p-7">
    <div class="text-center">
      ...
      <a class="text-primary decoration-2 hover:underline focus:outline-hidden focus:underline font-medium" href="{{ route('login.page') }}">
          Sign in here
        </a>
      </p>
    </div>
