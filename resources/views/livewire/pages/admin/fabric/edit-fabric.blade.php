        ...
        <div class="mb-4 sm:mb-8">
          ...
          @if ($image)
            <div class="mt-4">
              ...
              <img src="{{ $image->temporaryUrl() }}" alt="New fabric preview" class="object-cover rounded-lg w-40 h-40" />
            </div>
          @elseif ($existingImage)
            <div class="mt-4">
              <p class="mb-2 text-sm font-medium text-foreground">Current fabric image</p>
              <img src="{{ asset('storage/' . $existingImage) }}" alt="Current fabric image" class="object-cover rounded-lg w-40 h-40" />
            </div>
          @endif
        </div>
