      ...
      <div class="mt-5 p-4 relative z-10 bg-card border border-card-line rounded-xl sm:mt-10 md:p-10">
        <form wire:submit.prevent="save">
          ...
          <div class="mb-4 sm:mb-8">
            ...
            <input type="color" wire:model.live="color_code" wire:model.live="color_name"
              class="w-full h-10 rounded border border-layer-line cursor-pointer">
          </div>

          <!-- Color Name (auto-filled) -->
          <div class="mb-4 sm:mb-8">
            <label for="color_name" class="block mb-2 text-sm font-medium text-foreground">Color Name (hex)</label>
            <input wire:model.defer="color_name" type="text" id="color_name" 
              class="py-2.5 sm:py-3 px-4 block w-full bg-layer border-layer-line rounded-lg ..."
