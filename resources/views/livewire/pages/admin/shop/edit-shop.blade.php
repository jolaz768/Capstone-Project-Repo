          ...
          <div class="mb-4 sm:mb-8">
            ...
            @if ($shop_image)
              <div class="mt-4">
                ...
                <img src="{{ $existing_shop_image->temporaryUrl() }}" alt="image preview"
          ...
          <div class="mb-4 sm:mb-8">
            ...
            @if ($shop_logo)
              <div class="mt-4">
                ...
                <img src="{{ $existing_shop_logo->temporaryUrl() }}" alt="logo preview" class="object-cover rounded-lg w-40 h-40">
              </div>
            @endif
          </div>
          @error('shop_logo')
