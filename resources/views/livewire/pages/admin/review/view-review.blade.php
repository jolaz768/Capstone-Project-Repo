            ...
            <div class="sm:col-span-2 md:grow">
              <div class="flex justify-end gap-x-2">
                <div class="hs-dropdown [--placement:bottom-right] relative inline-block">
                  ...
                  <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-48 z-10 bg-dropdown border border-dropdown-line divide-y divide-dropdown-divider shadow-md rounded-lg p-2 mt-2" role="menu" aria-orientation="vertical" aria-labelledby="hs-as-table-table-export-dropdown">
                    <div class="py-2 first:pt-0 last:pb-0">
                      <span class="block py-2 px-3 text-xs font-medium uppercase text-muted-foreground">
                        Options
                      </span>
                  ...
                  <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-48 z-10 bg-dropdown border border-dropdown-line divide-y divide-dropdown-divider shadow-md rounded-lg mt-2" role="menu" aria-orientation="vertical" aria-labelledby="hs-as-table-table-filter-dropdown">
                    <div class="divide-y divide-dropdown-divider">
                      ...
                      <label for="hs-as-filters-dropdown-published" class="flex items-center py-2.5 px-3">
                        ...
                        <span class="ms-3 text-sm text-foreground">Published</span>
                      </label>
                      <label for="hs-as-filters-dropdown-pending" class="flex items-center py-2.5 px-3">
                        ...
                        <span class="ms-3 text-sm text-foreground">Pending</span>
                      </label>
                    </div>
                  </div>
                </div>
          ...
          <table class="min-w-full divide-y divide-table-line">
            ...
            <tbody class="divide-y divide-table-line">
              <tr class="bg-layer hover:bg-layer-hover">
                <td class="size-px whitespace-nowrap align-top">
                  <a class="block p-6" href="#">
                    <div class="flex items-center gap-x-4">
                      <img class="shrink-0 size-9.5 rounded-lg" src="https://images.unsplash.com/photo-1572307480813-ceb0e59d8325?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=320&h=320&q=80" alt="Product Image">
                      <div>
                        <span class="block text-sm font-semibold text-foreground">Brown Hat</span>
                      </div>
                    </div>
                  </a>
                </td>
                ...
                <td class="h-px w-72 min-w-72 align-top">
                  <a class="block p-6" href="#">
                    <div class="flex gap-x-1 mb-2">
                      <svg class="shrink-0 size-3 text-foreground" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <span class="block text-sm font-semibold text-foreground">I just love it!</span>
                ...
                <td class="size-px whitespace-nowrap align-top">
                  <a class="block p-6" href="#">
                    <span class="text-sm text-muted-foreground-2">10 Jan 2022</span>
                  </a>
                </td>
                <td class="size-px whitespace-nowrap align-top">
                  <a class="block p-6" href="#">
