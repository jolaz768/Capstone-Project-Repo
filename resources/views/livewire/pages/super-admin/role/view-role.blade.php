          ...
          <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-table-line">
            ...
            <div>
              <div class="inline-flex gap-x-2">
                ...
                <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg bg-primary border border-primary-line text-primary-foreground hover:bg-primary-hover focus:outline-hidden focus:bg-primary-focus disabled:opacity-50 disabled:pointer-events-none" href="{{ route('super-admin.role.create') }}">
                            ...
                            <tr wire:key="{{ $role_key }}">
                                ...
                                <td class="size-px whitespace-nowrap">
                                    <div class="px-6 py-3 text-end">
                                        <a href="{{ route('super-admin.role.edit', $role ?? '') }}"
                                ...
                                <td class="size-px whitespace-nowrap">
                                    <div class="px-6 py-3 text-end">
                                        <button wire:click="delete({{ $role->id }})" class="text-sm font-medium text-red-600 hover:underline">
                                            Delete
                                        </button>
                                    </div>
                                </td>
