<div>
  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="grid md:grid-cols-4 bg-layer border border-layer-line shadow-2xs rounded-xl overflow-hidden">
      <!-- Card -->
      <a class="block p-4 md:p-5 relative bg-layer hover:bg-layer-hover focus:outline-hidden focus:bg-layer-focus before:absolute before:top-0 before:start-0 before:w-full before:h-px md:before:h-full before:border-s before:border-layer-line first:before:bg-transparent"
        href="#">
        <div class="flex md:flex flex-col lg:flex-row gap-y-3 gap-x-5">
          <svg class="shrink-0 size-5 text-muted-foreground" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
          ...
          <div class="grow">
            ...
            <div class="mt-1 flex justify-between items-center">
              ...
              <span
                class="ms-1 inline-flex items-center gap-1.5 py-1 px-2 rounded-md text-xs font-medium bg-surface-1 text-surface-foreground">
                <svg class="inline-block size-3 self-center" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 mx-auto">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
      ...
      <div class="inline-flex rounded-full border border-layer-line bg-surface p-1">
        <button wire:click.prevent="setRange('daily')"
          class="rounded-full px-4 py-2 text-sm font-medium transition {{ $range === 'daily' ? 'bg-primary text-primary-foreground' : 'text-foreground hover:bg-layer-hover' }}">Daily</button>
        <button wire:click.prevent="setRange('weekly')"
          class="rounded-full px-4 py-2 text-sm font-medium transition {{ $range === 'weekly' ? 'bg-primary text-primary-foreground' : 'text-foreground hover:bg-layer-hover' }}">Weekly</button>
        <button wire:click.prevent="setRange('monthly')"
          class="rounded-full px-4 py-2 text-sm font-medium transition {{ $range === 'monthly' ? 'bg-primary text-primary-foreground' : 'text-foreground hover:bg-layer-hover' }}">Monthly</button>
      </div>
    </div>
    ...
    <div class="grid gap-4 lg:grid-cols-2">
      <div class="bg-layer border border-layer-line shadow-2xs rounded-xl p-5">
        <div class="flex items-center justify-between mb-4">
          ...
          <span
            class="rounded-full bg-surface px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">{{ ucfirst($range) }}</span>
        </div>
      ...
      <div class="bg-layer border border-layer-line shadow-2xs rounded-xl p-5">
        <div class="flex items-center justify-between mb-4">
          ...
          <span
            class="rounded-full bg-surface px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Unique</span>
        </div>
