                            ...
                            @forelse ($this->users() as $user_key => $user)
                                <tr wire:key="{{ $user_key }}">
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                            <div class="flex items-center gap-x-3">
                                                <div class="grow">
                                                    <span
                                                        class="block text-sm font-semibold text-foreground">{{ $user->name }}</span>
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="text-sm text-muted-foreground-1">{{ $user->roles->pluck('name')->map(fn($r) => str_replace('_', ' ', $r))->join(', ') }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-1.5">
                                            <a class="inline-flex items-center gap-x-1 text-sm text-primary decoration-2 hover:underline focus:outline-hidden focus:underline font-medium"
                                                href="{{ route('super-admin.user.edit', $user->id ?? '') }}">
                                                Edit
                                            </a>
                                        </div>
                                    </td>
